				...
				<div class="main-sidebar" id="sidebar-scroll">
					...
					<nav class="main-menu-container nav nav-pills flex-column sub-open">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide {{ request()->is('domains/settings') ? 'active' : '' }}">
										<a href="{{ route('domains.settings.edit') }}" class="side-menu__item">Domains Settings</a>
									</li>
								</ul>
						...
						<ul class="doublemenu_bottom-menu main-menu mb-0 border-top">
							...
							<!-- End::slide -->
							<!-- Start::slide -->
							{{-- Profile Settings link hidden per request --}}
							<!-- End::slide -->
							<!-- Start::slide -->
							<li class="slide">
								@php
									...
									$initials = $userName
										...
										: 'US';
								@endphp
								<a href="{{url('profile')}}" class="side-menu__item p-1 rounded-circle mb-0 d-flex align-items-center justify-content-center avatar avatar-md avatar-rounded bg-primary text-white fw-bold overflow-hidden">
									{{ $initials }}
								</a>
							</li>
							<!-- End::slide -->
