...
(function () {
    ...
    if (document.querySelector("#switcher-canvas")) {
        try {
            ...
            console.warn('Switcher initialization error:', error);
        }
    }
    /* LTR to RTL */
...
function switcherClick() {
    ...
    if (bgDefaultColor1Btn) {
        bgDefaultColor1Btn.addEventListener('click', () => {
            ...
            const darkMenu = document.querySelector('#switcher-menu-dark');
            const darkHeader = document.querySelector('#switcher-header-dark');
            if (darkTheme) darkTheme.checked = true;
            if (darkMenu) darkMenu.checked = true;
            if (darkHeader) darkHeader.checked = true;
    ...
    if (bgDefaultColor2Btn) {
        bgDefaultColor2Btn.addEventListener('click', () => {
            ...
            document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
            document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
            const darkTheme2 = document.querySelector('#switcher-dark-theme');
            const darkMenu2 = document.querySelector('#switcher-menu-dark');
            const darkHeader2 = document.querySelector('#switcher-header-dark');
            if (darkTheme2) darkTheme2.checked = true;
            if (darkMenu2) darkMenu2.checked = true;
            if (darkHeader2) darkHeader2.checked = true;
            localStorage.setItem("vyzorMenu", "dark");
            localStorage.setItem("vyzorHeader", "dark");
        });
    }
    if (bgDefaultColor3Btn) {
        bgDefaultColor3Btn.addEventListener('click', () => {
            ...
            document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
            document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
            const darkTheme3 = document.querySelector('#switcher-dark-theme');
            const darkMenu3 = document.querySelector('#switcher-menu-dark');
            const darkHeader3 = document.querySelector('#switcher-header-dark');
            if (darkTheme3) darkTheme3.checked = true;
            if (darkMenu3) darkMenu3.checked = true;
            if (darkHeader3) darkHeader3.checked = true;
            localStorage.setItem("vyzorMenu", "dark");
            localStorage.setItem("vyzorHeader", "dark");
        });
    }
    if (bgDefaultColor4Btn) {
        bgDefaultColor4Btn.addEventListener('click', () => {
            ...
            document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
            document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
            const darkTheme4 = document.querySelector('#switcher-dark-theme');
            const darkMenu4 = document.querySelector('#switcher-menu-dark');
            const darkHeader4 = document.querySelector('#switcher-header-dark');
            if (darkTheme4) darkTheme4.checked = true;
            if (darkMenu4) darkMenu4.checked = true;
            if (darkHeader4) darkHeader4.checked = true;
            localStorage.setItem("vyzorMenu", "dark");
            localStorage.setItem("vyzorHeader", "dark");
        });
    }
    if (bgDefaultColor5Btn) {
        bgDefaultColor5Btn.addEventListener('click', () => {
            ...
            document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
            document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
            const darkTheme5 = document.querySelector('#switcher-dark-theme');
            const darkMenu5 = document.querySelector('#switcher-menu-dark');
            const darkHeader5 = document.querySelector('#switcher-header-dark');
            if (darkTheme5) darkTheme5.checked = true;
            if (darkMenu5) darkMenu5.checked = true;
            if (darkHeader5) darkHeader5.checked = true;
            localStorage.setItem("vyzorMenu", "dark");
            localStorage.setItem("vyzorHeader", "dark");
        });
    }
